...
<div class="container-fluid">
  <div class="addgamehighlightes">
   <div class="addgamehighlightesinner">
     ...
     <form method="post" id="recommendForm" action="{{ route('coach.update-recomendation') }}" enctype="multipart/form-data">
      @csrf
      <input type="hidden" name="recommendId" value="{{ @$recommed_id }}">

      <div class="form-group">
        <label>Recommendation</label>
        <?php if(@$detail->updated_recommendation!=""){?>
          <textarea name="recommendation" id="recommend_txt" placeholder="Type here...">{{ @$detail->updated_recommendation }}</textarea>  
        <?php } else{ ?>
