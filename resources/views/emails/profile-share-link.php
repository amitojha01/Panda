...
<meta charset="utf-8">
    ...
    <body>        
        ...
        <p style="text-align: center;"><?php echo @$data['msg']; ?></p>      
         ...
         <a style="text-align: center; display: block; font-size: 20px; background: #fff; padding:10px 0; color: #5cb85c"  href="<?php echo url('/user-profile/'); ?><?php echo '/'.@$data['profile_id']; ?>"> <?php echo url('/user-profile/'); ?><?php echo '/'.@$data['profile_id']; ?></a>
