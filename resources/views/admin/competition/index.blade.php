        ...
        <div class="section-body">
            <div class="row">
                ...
                <div class="card">
                    ...
                    <a href="{{ route('competition.create') }}" class="btn btn-icon icon-left btn-info btn-list-add">
                        ...
                        <tbody>
                            ...
                            @foreach($competition as $key => $value)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('competition.edit', $value->id) }}" title="Update" class="btn btn-primary">
