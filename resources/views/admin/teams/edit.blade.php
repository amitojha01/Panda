                ...
                <form method="post" action="{{ route('team.update', $team->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group mb-0">
                            ...
                            required="" maxlength="1500" placeholder="Please enter at most 50 characters...." value="">{!! $team->bio !!}</textarea>
                            @if ($errors->has('bio'))
                        ...
                        <div class="form-group">
                            ...
                            <img class="preview-image mt-2" alt="image" src="{{ asset($team->image) }}" width="120px">
                            @if ($errors->has('image'))
