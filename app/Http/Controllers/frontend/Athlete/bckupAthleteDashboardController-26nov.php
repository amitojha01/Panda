...
class AthleteDashboardController extends Controller
{
    ...
    public function index()
    {
      ...
      ->get();                           
        ...
        //echo '<pre>';print_r($video_evidence);exit;
        ...
        */
		...
		foreach ($all_month as $single_month) {
            ...
            $all_val = UserAciIndexLog::where('user_id', Auth()->user()->id)->whereYear( 'created_at', date('Y'))->whereMonth( 'created_at', $single_month)->get();
            // echo $single_month;
            // print_r($all_val);
        ...
        $follower = Follower::where('follower_id', Auth()->user()->id)->get();
     ...
     * Get 
    */
    public function aciIndexCalculate()
    {
