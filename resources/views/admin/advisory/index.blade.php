        ...
        <div class="section-body">
            <div class="row">
                ...
                <div class="card">
                    ...
                    <h4>Advisory Board List</h4>
                    <a href="{{ route('advisory.create') }}" class="btn btn-icon icon-left btn-info btn-list-add">
                    ...
                    <div class="table-responsive">
                        ...
                        <tbody>
                            @if($advisory)
                            @foreach($advisory as $key => $advisory)
                                <tr>
                                    <td>{{ ($key+1) }}</td>                                    
                                    <td>{{ $advisory->name }}</td>
                                    <td>{{ $advisory->position }}</td>
                                    <td>
                                        <img class="col-image" alt="image" src="{{ asset($advisory->image) }}" width="35" height='105' style="padding:10px">
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="{{ route('advisory.edit', $advisory->id) }}" title="Update" class="btn btn-primary"> <i class="fas fa-edit"></i> </a>
