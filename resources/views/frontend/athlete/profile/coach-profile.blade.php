					...
					<div class="row">
						<div class="col-md-2 col-sm-12 col-xs-12">
							<div class="coachprofilebox_top_l">
								...
								<a href="{{ route('athlete.chat') }}" id="add_athbtn" class="msgbtn">Message</a>
							<?php } ?>
						...
						<div class="coachprofilebox_bottom">
							...
							<div class="row">
								<div class="col-md-6 col-sm-12 col-xs-12">
									<div class="dashboard_l_top coach_event_slider" style="margin-bottom:30px;">
