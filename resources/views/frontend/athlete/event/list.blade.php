        ...
        <div class="col-md-12">
            <div class="tab-container" id="CompareAjax">
                <div class="tab-menu">
                    ...
                    <ul>
                        <li><a href="#" class="tab-a <?php if($tab_id==1){ echo @$activetab; } ?>" data-id="tab1">My Events</a></li>
                        <li><a href="#" class="tab-a <?php if($tab_id==2){ echo @$activetab; } ?>" data-id="tab2">Event Opportunities</a></li>
                    </ul>
                </div>

                <div class="tab  <?php if($tab_id==1){ echo 'tab-active'; } ?>" data-id="tab1">
                    ...
                    <div class="clr"></div>
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="addathe_box_r">
                                    ...
                                    <a style="float:left;margin-top:10px;margin-bottom:10px" class="addevents_btn"
                                        href="{{route('athlete.add-events')}}">Add
                                        Events</a>
                        ...
                        <table class="tabtable" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <tr>
                                ...
                                <td><a href="{{ $user_event_details->url }}" target="_blank">{{ $user_event_details->url }}</a></td>
                                <td>
                                    <!-- <button data-id="" class="btn-delete-row comparison-delete"><i class="fa fa-trash-o"
                                            aria-hidden="true"></i></button> -->
                                            <a href="{{url('athlete/edit-events/'.$user_event_details->id)}}"><i class="fa fa-pencil"
                                            aria-hidden="true"></i></a>
                                            <a href="javascript:void(0)" data-id="{{$user_event_details->id}}"
                                            class="btn-delete-row"><i class="fa fa-trash-o"
                                            aria-hidden="true"></i></a>
                                </td>
                            </tr>
                            @endforeach
                ...
                <div class="tab  <?php if($tab_id==2){ echo 'tab-active'; } ?>" data-id="tab2">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="addathe_box_r">
                                    <!-- <a style="float:left;" class="addevents_btn"
                                        href="{{route('athlete.add-events')}}">Add Events</a> -->
                                ...
                                <div class="gamebox coachrecommendationsbox">
                                    <div class="coachsliderbox">
                                        <div class="coachslider_img eventnewlisticon">
                                            ...
                                            <img src="{{ asset('public/frontend/athlete/images/Icon awesome-calendar-check.png') }}"
    ...
    $('.btn-delete-row').on('click', function() {
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    $.ajax({
                        url: "{{url('athlete/delete-events')}}" + "/" + id,
                        type: 'POST',
                        data: {
                            "_token": "{{ csrf_token() }}",
                        },
