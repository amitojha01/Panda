                    ...
                    <div class="table-responsive">
                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img class="col-image" alt="image" src="{{ asset($stories->image) }}" width="35">
                                    </td>
                                    <td>
                                        @if($stories->status == 1)
                                    ...
                                    <td>
                                        <a href="{{ route('stories.edit', $stories->id) }}" title="Update" class="btn btn-primary"> <i class="fas fa-edit"></i> </a>
