        ...
        <div class="section-body">
            <div class="row">
                ...
                <div class="card">
                    ...
                    <a href="{{ route('exercises.create') }}" class="btn btn-icon icon-left btn-info btn-list-add">
                        ...
                        <tbody>
                            ...
                            @foreach($exercises as $key => $exercise)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('exercises.edit', $exercise->id) }}" title="Update" class="btn btn-primary">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="javascript:void(0)" data-id="{{ $exercise->id }}" title="Delete" class="btn btn-danger btn-delete-row">
