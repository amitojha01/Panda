                    ...
                    <div class="table-responsive">
                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img class="col-image" alt="image" src="{{ asset($services->image) }}" width="35">
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="{{ route('services.edit', $services->id) }}" title="Update" class="btn btn-primary"> <i class="fas fa-edit"></i> </a>
