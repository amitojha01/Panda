                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a onclick="backpage()" class="btn btn-icon icon-left btn-info btn-list-add">
                                Back
                            </a>
                                ...
                                <table class="table table-striped" id="table-1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                           ...
                                           <td>{{ str_replace('"', '', $list->name) }}</td>
                                            <td>{{ str_replace('"', '', $list->title) }}</td>
                                            <td>{{ $list->email }}</td>       
                                            <td>

                                             <a href="{{ route('admin.edit.coach', $list->id) }}" title="Update" class="btn btn-primary">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="javascript:void(0)" data-id="{{ $list->id }}" title="Delete" class="btn btn-danger btn-delete-row">
