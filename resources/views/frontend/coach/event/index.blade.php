...
<div class="createteamingup">
	<div class="container-fluid">
		<div class="addgamehighlightes">
			<form method="post" action="{{ route('coach.save-events') }}" enctype="multipart/form-data">
				@csrf
				<div class="addgamehighlightesinner">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<select class="form-control" id="city"  name="city" required>
									...
									<!-- <input type="text" class="form-control " value="{{isset($data)?($data->city):''}}"  name="city" placeholder="city" required/>  -->
									@if ($errors->has('city'))
							...
							<div class="col-md-6">
								<div class="form-group ">
									...
									<!-- <input type="text" class="form-control datepicker" value="{{isset($data)?(date('m/d/Y', strtotime($data->start_date))):''}}"  name="start_date" placeholder="MM-DD-YYYY" required/> -->
							...
							<div class="col-md-6">
								<div class="form-group ">
									...
									<!-- <input type="text" class="form-control datepicker" value="{{isset($data)?(date('m/d/Y', strtotime($data->end_date))):''}}"  name="end_date" placeholder="MM-DD-YYYY" required/> -->
									<span><i class="fa fa-calendar" aria-hidden="true"></i></span>
						...
						id="even_details" name="even_details" 
						placeholder="please provided link url...." required>{{isset($data)?($data->even_details):''}}</textarea> -->
