...
class ChatController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.athlete.chat.list')->with('chat_details', $chat_details)->with('det',$det);
    }
	...
	public function messagePage()
	{
		...
		// die;
		return view('frontend.athlete.chat.chat_List');
	}
