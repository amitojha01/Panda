...
$(document).ready(function(){
  ...
  $(".multipleSelect2").select2({
		placeholder: "Select individual workouts to track" //placeholder
	});
})
...
$(document).ready(function(){
    $('.tab-a2').click(function(e){  
      e.preventDefault();
      $(".tab2").removeClass('tab-active2');
      $(".tab2[data-id='"+$(this).attr('data-id')+"']").addClass("tab-active2");
      $(".tab-a2").removeClass('active-a2');
      $(this).parent().find(".tab-a2").addClass('active-a2');
     });
});
