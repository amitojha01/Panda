...
<link href="https://fonts.googleapis.com/css2?family=Poppins:wght@100;200;300;400;500;600;700;800;900&display=swap" rel="stylesheet">
    ...
    <body>
        ...
        <h2 style="text-align: center; font-size:40px; padding:30px 0px 0 0px; margin:0 0 0 0; color: #FFD500; font-family: 'Poppins', sans-serif;">Send Request</h2>
        <p style="padding:0px 100px 0 100px; text-align: center; font-size:16px; font-family: 'Poppins', sans-serif; color: #fff;">You Sent follow request to <?php echo @$data['receivername']; ?>. To view this request response click the link below </p>

         <a style="text-align: center; display: block; font-size: 20px;  padding:10px 0; color: #FFD500; font-family: 'Poppins', sans-serif;"  href="#"> <?php echo url('').'/athlete/connections';?></a>
        </div>       
