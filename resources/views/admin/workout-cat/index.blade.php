        ...
        <div class="section-body">
            <div class="row">
                ...
                <div class="card">
                    ...
                    <h4>Category List</h4>
                    <a href="{{ route('workoutcategory.create') }}" class="btn btn-icon icon-left btn-info btn-list-add">
                        ...
                        <tbody>
                            ...
                            @foreach($cat_data as $key => $value)
                                <tr>
                                    ...
                                    <td>
                                         @if($value->image != null) 
                                        <img src="{{ asset(@$value->image) }}" width="80px" />
                                         @endif
                                    ...
                                    <td>
                                        <a href="{{ route('workoutcategory.edit', $value->id) }}" title="Update" class="btn btn-primary"> <i class="fas fa-edit"></i> </a>
            ...
            $('.btn-delete-row').on('click', function(){
               let id = $(this).data('id');
                swal({
                    ...
                    if (willDelete) {
                        $.ajax({
                            url: "{{ url('admin/workoutcategory') }}"+"/"+id,
                            type:'delete',
                            data: {
                                "_token": "{{ csrf_token() }}",
                            },
