        ...
        <div class="section-body">
            <div class="row">
                ...
                <div class="card">
                    ...
                    <h4>College List</h4>
                    <a href="{{ route('colleges.create') }}" class="btn btn-icon icon-left btn-info btn-list-add">
                        ...
                        <tbody>
                            ...
                            @foreach($colleges as $key => $college)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('colleges.edit', $college->id) }}" title="Update" class="btn btn-primary">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="javascript:void(0)" data-id="{{ $college->id }}" title="Delete" class="btn btn-danger btn-delete-row">
