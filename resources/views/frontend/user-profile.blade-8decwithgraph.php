		...
		<div class="col-md-8 col-sm-12 col-xs-12">
			...
			<!-- <div class="col-md-12">
                <div class="newgamehighlight">
                	<div id="gamehighlightnew" class="owl-carouselz">
					...
					<div class="item">
						<div class="TeamingUPbox">
							...
							<div class="TeamingUPbox_text">
								...
								<!-- <span>26 members Created on 21 Aug 2021</span> -->
		...
		<div class="col-md-4 col-sm-12 col-xs-12">
			...
			<div class="myprofile">
				<div class="myprofile_l">
					...
					<img src="{{ asset($user->profile_image) }}" alt="user_img"/></div>
					@else
					<img src="{{ asset('public/frontend/athlete/images/user_img.png') }}" alt="user_img"/></div>
				...
				@if($exit_follower_user)
					...
					<div class="profiledetails">
						...
						<div class="profiledetails_l">
                            ...
                            <?php if($user_detail->contact_email==1  && $is_follow >0){?>
						...
						<div class="profiledetails_r">
                            ...
                            ->get();
                             ...
                             for($j=0; $j<count($user_sport); $j++){ ?>
                            <b>{{ @$user_sport[$j]->name  }}</b>
                        
                            <?php  } } ?> -->
                             <?php if($user_detail->profile_type==1  && $is_follow >0){?>
