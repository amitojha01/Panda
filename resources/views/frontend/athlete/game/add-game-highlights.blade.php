  ...
  <div class="addgamehighlightes">
   <div class="addgamehighlightesinner">
     ...
     <div class="form-group datrrecordtext">
      ...
      <form  action="{{ route('athlete.save-game-highlights') }}" method="POST" >
        @csrf
      ...
      <div class="form-group">
        ...
        <textarea placeholder="Type here..." name="description"></textarea> 
      ...
      <div class="form-group">
        ...
        <input type="url" class="form-control" name="video" id="vl" value="{{old('video')}}" placeholder="www.youtube.com/escf1"/>
        <input type="hidden" class="form-control " id="vel" name="video_embeded_link" placeholder="www.youtube.com/johndoebenchpressmax" value=""/>
        @if ($errors->has('video'))
