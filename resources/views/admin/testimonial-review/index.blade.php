        ...
        <div class="section-body">
            <div class="row">
                ...
                <div class="card">
                  ...
                  <a href="{{ route('testimonial-review.create') }}" class="btn btn-icon icon-left btn-info btn-list-add">
                           ...
                           @if($testimonial_review)
                            @foreach($testimonial_review as $key => $testimonial_review)
                                <tr>
                                    ...
                                    <td>{{($key+1)}}</td>
                                    <td>{{ $testimonial_review->name }}</td>
                                    <td>{{ $testimonial_review->comments }}</td>
                                     <td>
                                        <img class="col-image" alt="image" src="{{ asset($testimonial_review->image) }}" width="10">
                                    </td>
                                    <td>
                                        @if($testimonial_review->status == 1)
                                    ...
                                    <td>
                                        <a href="{{ route('testimonial-review.edit', $testimonial_review->id) }}" title="Update" class="btn btn-primary"> <i class="fas fa-edit"></i> </a>
