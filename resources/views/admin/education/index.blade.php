        ...
        <div class="section-body">
            <div class="row">
                ...
                <div class="card">
                    ...
                    <a href="{{ route('education.create') }}" class="btn btn-icon icon-left btn-info btn-list-add">
                        ...
                        <tbody>
                            ...
                            @foreach($education as $key => $value)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('education.edit', $value->id) }}" title="Update" class="btn btn-primary">
