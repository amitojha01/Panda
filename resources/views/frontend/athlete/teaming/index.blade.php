		...
		<div class="col-md-4 col-sm-12 col-xs-12">
			<div class="TeamingUPbox">
				<div class="TeamingUPbox_img">
					...
					<a href="{{  route('athlete.teamingup-group-details', ['id' => $value->id,'group-name'=>@$name_slug])}}">
						@if($value->image!="") 
                                                 ...
                                                 foreach($allWorkoutCategory as $key => $workOutValue){    
                                                    ...
                                                    $data = [];
                                                        if(count($workout_library) > 0){
                                                            ...
                                                            $data = WorkoutLibrary::where('status', 1)->orderBy('title', 'asc')->get();
                                                        }
                                                ?>
        ...
        <div class="modal-content">
            <div class="modal-body">
               <header>
                ...
                <button type="button" class="close close_relode" id="close" data-dismiss="modal" aria-label="Close" onclick="closeModal()">
                    <span aria-hidden="true">&times;</span>
                </button>
    ...
    <div class="modal-dialog filterpopup" role="document">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <form method="post" action="{{ url('athlete/add-group-teamingup') }}" id="createGroupForm_new" name="JobForm"  enctype="multipart/form-data">
                    @csrf     
                    <div class="container-fluid">
                            {{-- id="createGroupForm" --}}
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <input type="submit" class="creategroupbtn disable-create-group" id="group_submit_button_new" value="Create Group" disabled/> 
...
<script>
    ...
    // $("#group_submit_button_new").click(function (){
	// 	alert('gg_new');
	// 	// $("#createGroupForm_new").submit();
