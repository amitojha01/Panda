        ...
        <div class="section-body">
            <div class="row">
                ...
                <div class="card">
                    ...
                    <h4>School Playing List</h4>
                    <a href="{{ route('schoolplaying.create') }}" class="btn btn-icon icon-left btn-info btn-list-add">
                    ...
                    <div class="table-responsive">
                        ...
                        <tbody>
                            @if($schoolplaying)
                            @foreach($schoolplaying as $key => $value)
                                <tr>
                                    <td>{{ ($key+1) }}</td>
                                    ...
                                    <td>
                                        <a href="{{ route('schoolplaying.edit', $value->id) }}" title="Update" class="btn btn-primary">
            ...
            $('.btn-delete-row').on('click', function(){
               let id = $(this).data('id');
                swal({
                    ...
                    if (willDelete) {
                        $.ajax({
                            url: "{{ url('admin/schoolplaying') }}"+"/"+id,
                            type:'delete',
                            data: {
                                "_token": "{{ csrf_token() }}",
                            },
