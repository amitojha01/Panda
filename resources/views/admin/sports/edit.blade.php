                ...
                <form method="post" action="{{ route('sports.update', $sport->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="card-body">                        
                        ...
                        <div class="form-group">
                            ...
                            @if($sport->icon != null)   
                                <img class="preview-image mt-2" style="background-color: black " alt="icon" src="{{ asset($sport->icon) }}" width="120px">
                            @endif
                            @if ($errors->has('icon'))
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control form-control-sm @error('status') is-invalid @enderror" name="status" required>
                                <option value="1" {{ $sport->status == 1 ? 'selected' : ''}}>Active</option>
                                <option value="0" {{ $sport->status == 0 ? 'selected' : ''}}>Inactive</option>
                            </select>
