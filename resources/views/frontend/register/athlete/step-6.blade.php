...
@section('title', 'Registration | Athlete | Colleges')
@section('style')
    ...
    <div class="signinbox createaccount2">
        ...
        <div class="searchpanelbox desiredcollegessearch">
            ...
            <div class="filter">
             ...
             <a href="<?php echo $_SERVER["REQUEST_URI"]; ?>" style="display:none" id="resetbtn">Reset</a>
                
                
            <div class="clr"></div>
        </div>
        <div class="signinbox">
                <h6 id="nores" style="display:none">No Result Found!!</h6>
            </div>
        
        <form id="frmRegistrationStep-5" method="post" action="{{ route('registration.athlete.step-five') }}">
            @csrf
            <div class="signinbox" id="clist">              
            ...
            <input type="submit" class="savecontinue" value="Skip"/>
  ...
  <div class="modal-dialog filterpopup" role="document">
    <div class="modal-content">      
      <div class="modal-body">
        ...
        <label style="color:#fff">Select Division</label> 
         ...
         <label style="color:#fff">Select State</label> 
        <div class="searchmodalbox">       	 	
			<div class="searchmodalbox_l">
                <i class="fa fa-flag" aria-hidden="true"></i>
            </div>	
         ...
         <label style="color:#fff">Select Conference</label> 
        <div class="searchmodalbox">       	 	
			<div class="searchmodalbox_l">
                <i class="fa fa-flag" aria-hidden="true"></i>
            </div>	
       	...
       	<div align="center">
            <button type="button" class="showresult" id="get-filter">Show Results</button></div>
      </div>      
    </div>
  </div>
</div>
