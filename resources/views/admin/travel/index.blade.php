        ...
        <div class="section-body">
            <div class="row">
                ...
                <div class="card">
                    ...
                    <h4>Travel List</h4>
                    <a href="{{ route('travel.create') }}" class="btn btn-icon icon-left btn-info btn-list-add">
                        ...
                        <tbody>
                            ...
                            @foreach($travel as $key => $value)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('travel.edit', $value->id) }}" title="Update" class="btn btn-primary">
