...
<meta charset="utf-8">
    ...
    <body>        
        ...
        <h2 style="text-align: center; background: #5cb85c; padding:30px 0; color: #fff">Request</h2>
        <p style="padding:15px 0 0 0; font-size: 20spx; text-align: center; font-size:16px;">You have been invited by <?php echo @$data['creator_name'] ?><<?php echo @$data['creator_email'] ?>>. To accept this invitation click the link below </p>      
