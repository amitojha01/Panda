        ...
        <div class="section-body">
            <div class="row">
                ...
                <div class="card">
                    ...
                    <h4>Team List</h4>
                    <a href="{{ route('team.create') }}" class="btn btn-icon icon-left btn-info btn-list-add">
                        ...
                        <tbody>
                            ...
                            @foreach($teams as $key => $team)
                                <tr>
                                    ...
                                    <td>{{ $team->position }}</td>
                                    <td>
                                        <img class="col-image" alt="image" src="{{ asset($team->image) }}" width="35" height='105' style="padding:10px">
                                    </td>
                                    <td>
                                        @if($team->status == 1)
                                    ...
                                    <td>
                                        <a href="{{ route('team.edit', $team->id) }}" title="Update" class="btn btn-primary"> <i class="fas fa-edit"></i> </a>
