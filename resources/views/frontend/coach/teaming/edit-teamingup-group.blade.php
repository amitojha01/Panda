...
<div class="container-fluid">
 <form method="post" action="{{ route('coach.update.teaming_group', $group_detail->id) }}" id="createGroupForm" enctype="multipart/form-data">
  @csrf 
  <div class="row">
...
<script>
  ...
  function checkGroup(dis){
    ...
    $.ajax({
      url:"{{url('coach/check-teaming-group')}}",
      type: "GET",
      data: {
